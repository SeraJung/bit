...
public class Test40 {
  public static void main(String[] args) {
    ...
    1) Car  클래스에 선언된 대로 인스턴스 변수를 준비한다.
         : maker, model, cc, diesel, releasDate, capacity
    2) Tructk 클래스에 선언된 인스턴스 변수 준비
          : weight
     3) 각 인스턴스 변수는 0으로 초기화 된다.
        ...
        - 레퍼런스 => null => 모든 비트 0
     3) 초기화 문장 수행(super 클래스의 명령어 부터 실행)
     4) 생성자 호출 (Truck) -> Car() 호출)
     
    */
/*
1) 인스턴스 변수 준비
[maker][model][cc  ][dies][release...][capa..][weigth][autoDump]

2) 인스턴스 변수를 0을 초기화
[0    ][0    ][0   ][0   ][null(0)   ][0     ][0.0   ][false(0)]

3) Car 클래스의 초기화 문장 수행 
[0    ][0    ][800 ][0   ][null(0)   ][5     ][0.0   ][false(0)]  
     Truck 클래스의 초기화 문장 수행 
[0    ][0    ][800 ][0   ][null(0)   ][5     ][1000.0][false(0)]
4) Truck 클래스 생성자 호출하는 즉시 Car 생성자 호출 함.
