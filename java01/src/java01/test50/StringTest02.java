/* 상수 문자열
 - "문자열" 식으로 표현
 - 내부적으로는 String 클래스의 인스턴스를 생성한다.
 - String Pool 영역에 생성한다.
 - 중복 생성되지 않는다.
 
 Method Area영역에 클래스가 로딩되면, 각 클래스 별로 상수문자열의 String 인스턴스
 가 생선된다.
 ...
 * String Pool
 - 상수 문자열을 보관하는 메모리 영역
 - Method Area의 일부분이다.
 - 상수 문자열은 자주 사용되기 대문에, 메모리 낭비를 줄이기 위해
...
public class StringTest02 {
 ...
 static  class B{
  ...
  public static void main(String[] args) {
   String str1 = "Hello";//String Pool에 인스턴ㄴ스 생성 후 주소 리턴
   ...
   String str3 = new String("Hello");
    ...
    //객체이기 대문에 == 연산자는 문자열이 아닌 주소를 비교하므로
    //문자열 비교를 할 수 없다.
