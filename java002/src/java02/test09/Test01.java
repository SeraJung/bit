/* Command 인터페이스를 제거하고 Command 애노테이션을 사용하여
 * 명령처리 클래스를 만든다.
 * 
 * 목표
 * 1) 메서드 애노테이션을 붙이는 방법
...
import java02.test09.command.AddCommand;
...
public class Test01 {
  ...
  public void init() throws Exception {
    ...
    for (Class clazz : clazzList) {
      ...
      command = (Object)clazz.newInstance();
      ...
      try{
        ...
        method = clazz.getMethod("setScnner", Scanner.class);        
        // System.out.println(clazz.getName() + "." + method.getName());
    ...
    while (true) {
      try {
        ...
        Set<Method> methods =  ReflectionUtils.getMethods(
           command.getClass() , /*매서드를 찾을 클래스 타입*/       
