...
public class Test01 {
  ...
  public static void main(String[] args) {
    // 현재 이명령을 수행하는 스레드 알아내기
    Thread t =Thread.currentThread();
    System.out.println("1) main()호출 스래드 : " + t.getName());
    
    //메인 스레드가 소속되어 있는 스레드 그룹 알아내기.
    ThreadGroup g = t.getThreadGroup();
    System.out.println("2) main스래드가 소속된 그룹 : " +g.getName());
    
    //main 스레드 그룹의 상위그룹 알아내기.
